...
import (
	...
	"github.com/rosas99/gin/internal/bytesconv"
	"github.com/rosas99/gin/render"
...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://github.com/rosas99/gin/blob/master/docs/doc.md#dont-trust-all-proxies for details.")
	}
...
func (engine *Engine) RunQUIC(addr, certFile, keyFile string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://pkg.go.dev/github.com/rosas99/gin#readme-don-t-trust-all-proxies for details.")
	}
