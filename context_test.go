...
import (
	...
	testdata "github.com/rosas99/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/rosas99/gin.handlerNameTest$", c.HandlerName())
}
...
func TestContextInitQueryCache(t *testing.T) {
	validURL, err := url.Parse("https://github.com/rosas99/gin/pull/3969?key=value&otherkey=othervalue")
	require.NoError(t, err)
